...
// Logs
	...
	#define SPH_ERROR(...) { ::Sharpheus::Logger::GetEngineLogger()->error(__VA_ARGS__); SPH_BREAK(); }
	#define SPH_FATAL(...) { ::Sharpheus::Logger::GetEngineLogger()->critical(__VA_ARGS__); SPH_BREAK(); }

...
namespace Sharpheus {
	...
	void ClassRegistry::Init()
	{
		...
		classInfos[GameObject::Type::CppBehavior]				= &PlaceholderBehavior::classInfo;
		classInfos[GameObject::Type::PythonRunnerBehavior]		= &PythonRunnerBehavior::classInfo;
		...
		classInfos[GameObject::Type::Circle]					= &Circle::classInfo;

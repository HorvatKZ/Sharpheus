...
namespace Sharpheus {
	...
	void ClassWriter::UpdateCreateBehaviorHeader(const wxString& filePath, const wxString& newClassPath, const wxString& newClassName, uint32 newSubType, const std::unordered_map<uint32, std::string>& oldClasses)
	{
		uint32 ind = 9;
		wxTextFile file;
		file.Open(filePath);
		...
		ClassWriter cw(filePath, "BehaviorCreator", "Sharpheus::BehaviorCreatorBase", true, "This file is generated by Sharpheus. Do not edit!");
	...
	void ClassWriter::UpdateCreateBehaviorSource(const wxString& filePath, const wxString& newClassName, uint32 newSubType, const std::unordered_map<uint32, std::string>& oldClasses)
	{
